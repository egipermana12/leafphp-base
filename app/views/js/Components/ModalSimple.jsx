...
const ModalSimple = ({ isOpen, onClose, title, children, acceptLabel, declineLabel, onAccept, onDecline }) => {
  ...
  return createPortal(
    <>
      ...
      >
        <div className="relative p-4 w-full max-w-2xl max-h-full transform translate-x-1/2 translate-y-1/2">
